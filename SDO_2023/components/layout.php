...
<div  style="width:600px; height: 160px; padding-top:5px; padding-left:10px; text-align:center;"  class="content">
    <form style="width:575px; height:145px;  " method="POST" action = '../task/add_task.php'>
            <div class="input-group">
                <label style="padding:0px; margin-top1:3px;" for="Title">Наименование задачи</label>
                <input type="text"  name="Zadacha" required> <br>
                <button style="margin-top:3px; text-align:center;"type="submit" class="btn" name="add_task"> Отправить в БД </button>
            </div>
    </form>
</form>
</div>
